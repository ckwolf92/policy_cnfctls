%% MONETARY POLICY SHOCK IRFs: ALTERNATIVE ID SCHEMES
...
vardata = [ad_shock ygap infl lpcom mar_svariv ffr];
vardata = vardata(startdate:enddate,:);
vardata(isnan(vardata)) = 0;

% series names

series_names = {'Shock 1','Output','Inflation','Commodity Prices','Shock 2','Interest Rate'};
